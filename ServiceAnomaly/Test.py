...
class Test:
    ...
    def test_metric_gathering(self,destination):
            ...
            #request_duratoin
            with open(file_path+'/'+destination+'_request_duratoin.json') as json_file:
            ...
            #request_byte
            with open(file_path + '/' + destination + '_request_byte.json') as json_file:
            ...
            #################################################
            #response_byte
            with open(file_path + '/' + destination + '_response_byte.json') as json_file:
            ...
            ###############################################
            # Queue Size
            with open(file_path + '/' + destination + '_queue_size.json') as json_file:
            ...
            ###############################################
            # Latency
            with open(file_path + '/' + destination + '_latency.json') as json_file:
            ...
            ###############################################
            # Throughput
            with open(file_path + '/' + destination + '_throughput.json') as json_file:
