...
if __name__ == '__main__':
    ...
    #lists inclduing all relationships for all edges
   ...
   ###################################################
    ...
    #dag.edges =[('productpage.default','details.default'),('productpage.default','reviews.default'),('reviews.default','rating.default'),('reviews.default','rating.default'),('reviews.default','rating.default')]
    ...
    #############print avg of relashionships per edges####################################
    ...
    while (True):
            ...
            for edge in test.dag_test.edges:
                 ...
                 metric_test=test.test_metric_gathering(destination_test)
                             ...
                             for rel in dic["relations"]:
                                 try:
                                     ...
                                     if abs(y_test-y_predict)>abs(error):
                                         print(str(error)+" "+str(y_test-y_predict))
